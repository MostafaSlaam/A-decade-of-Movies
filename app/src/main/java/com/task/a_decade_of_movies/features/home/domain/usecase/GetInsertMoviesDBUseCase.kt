...
class GetInsertMoviesDBUseCase @Inject constructor(
    private val repository: HomeRepository
) : BaseUseCase<List<MovieModel>, Flow<DataState<Unit>>> {
    override suspend fun execute(input: List<MovieModel>): Flow<DataState<Unit>> {
        return repository.insertMoviesDB(input)
    }
